...
import { MdOutlineClose, MdAttachEmail, MdOutlineWeb } from "react-icons/md";
         ...
         <div className="flex flex-col gap-1 items-center py-5">
            ...
            <form className="w-full max-w-lg flex flex-col justify-center items-center gap-5">
               <p className="text-base text-center">
                  ...
                  directamente con tu gestor personal a través de correo
                  electrónico. Este sistema te ofrece una comunicación rápida y
