            ...
            <div className="relative">
               <svg width="100" height="100" viewBox="0 0 42 42" className="donut">
                     ...
                     <path className="donut-segment" d="M21 5.084505690810463 A 15.91549430918954 15.91549430918954 0 1 1 20.9999 5.084505690810463"
                        fill="transparent" stroke="#d8d8d8" strokeWidth="3" strokeDasharray="calc(80 * 100 / 100) calc(100 - (80 * 100 / 100))"
                        strokeDashoffset="25" strokeLinecap="round"></path>
               </svg>
               <span className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-xl font-semibold text-black">80%</span>
            </div>
         </div>
      </div>
   );
