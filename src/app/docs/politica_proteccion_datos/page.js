...
export default function DocsPoliticaProteccionDatos() {
    return (
        <div className="pl-52 pr-52 py-7 flex flex-col justify-start items-center gap-5 min-h-[83vh] h-auto">
            ...
            <p><Link href="/ndocs" className="italic underline">Documentación</Link> / <Link href="/docs" className="italic underline">Protección de datos</Link> / <Link href="/docs/politica_proteccion_datos" className="italic underline">Política de protección de datos</Link></p>
