                           ...
                           {tickets.map((ticket) => (
                              <tr key={ticket.id} className="border-b">
                                 ...
                                 <td className="px-4 py-2 text-center flex items-center">
                                    ...
                                    <Link className="text-mainColor text-2xl" href="/tickets/pendientes"><MdDeleteForever className="hover:scale-125 transition-transform duration-300 ease-in-out text-red-900" /></Link>
                                 </td>
                              </tr>
                           ))}
                        </tbody>
