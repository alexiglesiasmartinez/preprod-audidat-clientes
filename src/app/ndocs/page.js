...
export default function Ndocs() {
  return (
    <div className="pl-52 pr-52 py-7 flex flex-col justify-start items-center gap-5 h-screen">
      ...
      <div className="grid grid-cols-4 justify-center align-middle text-center gap-0">
        <Link href="/docs">
          <div className="flex flex-col justify-center gap-3 h-72 w-72 rounded-3xl border border-gray-200 shadow-lg p-5 m-5 hover:scale-105 transition-transform duration-300 ease-in-out">
            <div className="border-8 rounded-full border-gray-500 w-[100px] mx-auto">
              <Image src="/ndocs1.png" className="mx-auto border-8 rounded-full border-mainColor p-2" width={100} height={100} />
            </div>
        ...
        <div className="flex flex-col justify-center gap-3 h-72 w-72 rounded-3xl border border-gray-200 shadow-lg p-5 m-5">
          <div className="border-8 rounded-full border-gray-500 w-[100px] mx-auto">
            <Image src="/ndocs2.png" className="mx-auto border-8 rounded-full border-mainColor p-2" width={100} height={100} />
          </div>
        ...
        <div className="flex flex-col justify-center gap-3 h-72 w-72 rounded-3xl border border-gray-200 shadow-lg p-5 m-5">
          <div className="border-8 rounded-full border-gray-500 w-[100px] mx-auto">
            <Image src="/ndocs3.png" className="mx-auto border-8 rounded-full border-mainColor p-2" width={100} height={100} />
          </div>
        ...
        <div className="flex flex-col justify-center gap-3 h-72 w-72 rounded-3xl border border-gray-200 shadow-lg p-5 m-5">
          <div className="border-8 rounded-full border-gray-500 w-[100px] mx-auto">
            <Image src="/ndocs4.png" className="mx-auto border-8 rounded-full border-mainColor p-2" width={100} height={100} />
          </div>
