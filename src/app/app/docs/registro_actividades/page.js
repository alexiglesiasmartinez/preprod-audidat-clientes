    ...
    return (
        <>
            <div className="pl-16 pr-16 py-7 flex flex-col justify-start items-center gap-5 min-h-[83vh] h-auto">
                ...
                <p><Link href="/app/ndocs" className="italic underline">Documentación</Link> / <Link href="/app/docs" className="italic underline">Protección de datos</Link> / <Link href="/app/docs/registro_actividades" className="italic underline">Registro de actividades de tratamiento</Link></p>
                ...
                <div className="grid grid-cols-3 justify-center align-middle text-center gap-0">
                    <Link href="/app/docs/registro_actividades">
